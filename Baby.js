...
var day_clac = (new Date()).toLocaleString()// 获取当前日期
$ui.toast(day_clac)
var day_dis = displaydate(day_clac)// 显示当前日期
var DEFAULT_ = ["2018年1月13日 星期六 ","2018-01-12T16:00:00.000Z","",1,"#FF9F01","#FA8D01","#409EF6","#2C86D9"]
//[day_dis, day_clac, "", 0, "", "", ""]//设置默认日期
