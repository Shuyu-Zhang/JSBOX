var wid = $device.info.screen.width//获取插件宽度
...
var date_ = {
  ...
  props: {
    id: "date_",
    text: (SETTING_[0] === "" | SETTING_[0] === null ? day_clac : SETTING_[0]),
    font: $font("bold", 17),
    color: $color("#545455"),
    bgcolor:$color("clear")
  },
...
function pickdate() {
  $pick.date({
    props: {
      mode: 1,
      min: new Date("1700-01-01T00:00:00.000Z"),
      max: new Date("2099-12-31T24:00:00.000Z"),
